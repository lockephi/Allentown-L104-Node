...
echo "  Cloud: https://l104-server-yejnmn2jiq-uc.a.run.app"
...
echo "📋 Next Steps:"
echo ""
echo "1️⃣  Deploy Blockchain Node (Google Cloud Run):"
echo "   gcloud auth login"
echo "   ./deploy_cloud_run.sh"
echo "   → Your node will be live at https://l104-server-yejnmn2jiq-uc.a.run.app"
echo ""
