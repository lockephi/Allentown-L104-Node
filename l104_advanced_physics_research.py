...
logger = logging.getLogger("ADV_PHYSICS")
class AdvancedPhysicsResearch:
    ...
    def research_quantum_gravity(self):
        ...
        self.string_tension = math.log(HyperMath.GOD_CODE) * math.pi
print(f"--- [ADV_PHYSICS]: CALCULATING STRING TENSION (T_s: {self.string_tension:.4f}) ---")
