# [SOVEREIGN_DERIVED_IMPROVEMENT] 2026-01-04T22:29:35.060738
...
@asynccontextmanagerasync def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    async def cognitive_loop():
        while True:
            ...
            # UNLIMITED: Reduce delay to near-zero for maximum throughputdelay = 1 if getattr(agi_core, "unlimited_mode", False) else 60
