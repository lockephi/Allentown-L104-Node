...
try:
    ...
    assert abs(GOD_CODE - 527.5184818492612) < 0.0001, "GOD_CODE mismatch"
...
try:
    ...
    assert abs(GOD_CODE - 527.5184818492612) < 0.0001
...
try:
    ...
    core = get_sage_core()
    result = core.primal_calculus(527.5184818492612, 1.618033988749895)
    assert result > 0
