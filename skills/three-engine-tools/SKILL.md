---
name: three-engine-engine-tools
description: Provides a CLI to interact with the L104 Three-Engine Unified. Use for direct engine operations, status checks, cross‑engine validation, and unified analysis. Triggers on phrases like "run Three-Engine Unified analysis", "check Three-Engine Unified status", "validate with Three-Engine Unified", or "cross‑engine".
---

# Three-Engine Unified Tools

This skill provides a command‑line interface (`l104-three-engine`) for direct interaction with the L104 Three-Engine Unified. Use this tool to perform engine‑specific operations, retrieve status, and execute cross‑engine workflows.

The tool is located at `/Users/carolalvarez/Applications/Allentown‑L104‑Node/l104-three-engine`.

## Commands

### `status`
**Action**: Get the current status of the Three-Engine Unified.
- Shows availability, uptime, internal metrics, and any errors.
**Usage**:
```bash
l104-three-engine status
```

### `analyze`
**Action**: Perform a unified analysis using the Three-Engine Unified.
...
**Usage**:
```bash
l104-three-engine analyze --code "print('hello')" --science '{"entropy": 0.5}' --math '{"god_code_target": 1.618}'
l104-three-engine analyze --text "Your input text"
```
...
**Usage**:
```bash
l104-three-engine validate --input input.json
```
...
**Usage**:
```bash
l104-three-engine cross‑engine --operation entropy_analysis
```
...
**Usage**:
```bash
l104-three-engine simulate --type coherence_evolution
```
...
- Tool name: `l104_three-engine` (or similar)
