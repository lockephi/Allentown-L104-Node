...
class TestL104Constants(unittest.TestCase):
    ...
    def test_god_code_value(self):
        """GOD_CODE must equal 527.5184818492537."""
        self.assertAlmostEqual(L104Constants.GOD_CODE, 527.5184818492537, places=10)
...
class TestModuleTemplateGeneration(unittest.TestCase):
    ...
    def test_template_includes_header(self):
        ...
        self.assertIn("INVARIANT: 527.5184818492537", template)
    ...
    def test_template_includes_god_code(self):
        ...
        self.assertIn("self.god_code = 527.5184818492537", template)
